...
$query4="insert into jobs (title,jobdesc,vacno,experience,basicpay,fnarea,ugqual,pgqual,profile,postdate )VALUES ('$desig','$desc','$vacno','$exp','$pay','$fnarea','$ug','$pg','$profile','$date')";
...
if (!mysqli_query($db1,$query4))
{
 echo("Error description: " . mysqli_error($db1));
    ...
    header('location:index.php?msg=jobposted');
}
?>