...
if(isset($_POST['company_name'])){
    ...
    $sql = "update projects set project_url='$pro_url' where company_name='".$com_name."' and project_name='".$pro_name."'";
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" method="post" id="form"action="updateProjects.php">
